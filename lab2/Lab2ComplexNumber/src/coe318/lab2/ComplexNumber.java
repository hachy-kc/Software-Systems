...
//Initialize the instance variables
    ...
    public ComplexNumber add(ComplexNumber z) {
        double x = realnum;
        double y = imagnum;
        double rnew = z.realnum;
        double inew = z.imagnum;
        return new ComplexNumber((x + rnew),(y + inew));	//A stub: to be fixed
    }
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        ...
        double rnew = z.realnum;
        double inew = z.imagnum;
        return new ComplexNumber((x*rnew - y*inew), (x*inew + y*rnew));	//A stub: to be fixed
    }
    ...
    public ComplexNumber divide(ComplexNumber z) {
        ...
        double rnew = z.realnum;
        double inew = z.imagnum;
        return new ComplexNumber((x*rnew + y*inew)/(rnew*rnew + inew*inew), (x*inew - y*rnew)/ (rnew*rnew + inew*inew));	//A stub: to be fixed
    }
